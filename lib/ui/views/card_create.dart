        ...
        return Container(
          ...
          child: RaisedButton(
            ...
            onPressed: (){
              ...
              StripePayment.setOptions(StripeOptions(publishableKey: "pk_live_1KvYzTvYkGhOQuEfcLR4EF1w0056Hev0tF"));
                   ...
                   String uid=(await Auth().currentUser()).uid;
                    ...
                    db.listenForSources().listen((data){
                      ...
                      if(data.documents.length==0)return;
                        ...
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> ShoppingCartView()));
                      }
                    });
                    db.listenForErrors().listen((snaps){
                      for(DocumentSnapshot d in snaps.documents){
                        if(d.data['tokenId']!=null&&((d.data['tokenId'].toString()).compareTo(token.toJson()['tokenId'])==0)){
