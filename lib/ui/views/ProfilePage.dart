...
class _ProfilePageState extends State<ProfilePage> {
  ...
  static const NAME=0,EMAIL=1,ADDRESS=2,SOCIETY=3,VAT=4,CODICE=5;
                        ...
                        child: Column(
                          children: <Widget>[
                                ...
                                child: Container(
                                  ...
                                  child: GestureDetector(
                                    onTap: ()async{
                                      ...
                                      StorageReference storageRef=FirebaseStorage.instance.ref().child('avatars').child('${user.uid}.jpg');
                                      storageRef.putFile(img).onComplete.then((snap)async{
                                        String url=(await snap.ref.getDownloadURL()).toString();
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundImage:user.profileUrl==null?AssetImage('assets/profile.png'):NetworkImage(user.profileUrl,),
                                    ),
                                  ),
                                ),
                              ),
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    user.name??="N/A",
                                    style: style.headerStyle3.copyWith(color: Colors.white),
                                  ),
                                  InkWell(
                                    onTap: (){
                                    ...
                                    child: Container(
                                      ...
                                      height: 45.0,
                                      child: Center(
                                        child: Icon(Icons.power_settings_new,size: 35,color: Colors.white,),
                                      ),
                                    ),
                                  ),
                                ],
                            ...
                            GridView.count(
                              ...
                              children: <Widget>[
                                _buildCard(
                                    'Punti Premio', '155', Icons.card_giftcard, 1),
                                _buildCard(
                                    'Ordini in corso', '5', Icons.arrow_upward, 2),
                              ],
                            ),
                            SizedBox(
                              height: 15.0,
                                      ...
                                      InkWell(
                                        onTap: (){
                                          if(nameController.text!=user.name){
                                            ...
                                            Provider.of<UserModel>(context).setName(nameController.text);
                                          }else{
                                            setState(() {
                                              isEdit[NAME]=!isEdit[NAME];
                                            });
                                          }
                                        }, child: Icon(isEdit[NAME]?Icons.check:Icons.edit))
                                    ],
                                  ),
                                ),
                                //Email
                                      ...
                                      InkWell(
                                          onTap: (){
                                            if(addressController.text!=user.address){
                                              isEdit[ADDRESS]=!isEdit[ADDRESS];
                                              Provider.of<UserModel>(context).setAddress(addressController.text);
                                            }else{
                                              setState(() {
                                                isEdit[ADDRESS]=!isEdit[ADDRESS];
                                              });
                                            }
                                          }, child: Icon(isEdit[ADDRESS]?Icons.check:Icons.edit))
                                    ],
                                  ),
                                ),
                                //Society
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            isEdit[SOCIETY]?TextField(
                                              controller: societyController,
                                              maxLines: 1,
                                            ):Text(
                                              societyController.text??="N/A",
                                              style: style.subHintTitle,
                                            )
                                          ],
                                        ),
                                      ...
                                      InkWell(
                                          onTap: (){
                                            if(societyController.text!=user.society){
                                              isEdit[SOCIETY]=!isEdit[SOCIETY];
                                              Provider.of<UserModel>(context).setSociety(societyController.text);
                                            }else{
                                              setState(() {
                                                isEdit[SOCIETY]=!isEdit[SOCIETY];
                                              });
                                            }
                                          }, child: Icon(isEdit[SOCIETY]?Icons.check:Icons.edit))
                                    ],
                                  ),
                                ),
                                //VAT
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            isEdit[VAT]?TextField(
                                              controller: vatController,
                                              maxLines: 1,
                                            ):Text(
                                              vatController.text??="N/A",
                                              style: style.subHintTitle,
                                            )
                                          ],
                                        ),
                                      ...
                                      InkWell(
                                          onTap: (){
                                            if(vatController.text!=user.vat){
                                              isEdit[VAT]=!isEdit[VAT];
                                              Provider.of<UserModel>(context).setVAT(vatController.text);
                                            }else{
                                              setState(() {
                                                isEdit[VAT]=!isEdit[VAT];
                                              });
                                            }
                                          }, child: Icon(isEdit[VAT]?Icons.check:Icons.edit))
                                    ],
                                  ),
                                ),
                                //Codice
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            isEdit[CODICE]?TextField(
                                              controller: codiceController,
                                              maxLines: 1,
                                            ):Text(
                                              codiceController.text??="N/A",
                                              style: style.subHintTitle,
                                            )
                                          ],
                                        ),
                                      ...
                                      InkWell(
                                          onTap: (){
                                            if(codiceController.text!=user.codice){
                                              isEdit[CODICE]=!isEdit[CODICE];
                                              Provider.of<UserModel>(context).setCodice(codiceController.text);
                                            }else{
                                              setState(() {
                                                isEdit[CODICE]=!isEdit[CODICE];
                                              });
                                            }
                                          }, child: Icon(isEdit[CODICE]?Icons.check:Icons.edit))
                                    ],
                                  ),
                                ),
                              ],
